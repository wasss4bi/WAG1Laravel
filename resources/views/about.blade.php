    ...
    <div class="row justify-content-center text-center">
        ...
        <div class="col-lg-8">
            <p class="fs-4 text-muted">
                Компания "МастерЛектор" является ведущим провайдером аренды помещений для проведения мастер-классов,
                семинаров и тренингов. Мы специализируемся на предоставлении уютных, функциональных и вдохновляющих
                пространств, которые подходят для различных видов образовательных мероприятий.
            </p>
            <p class="fs-4 text-muted">
                Наша миссия - обеспечить лекторам и организаторам мероприятий идеальные условия для проведения их
                программ. Мы стремимся создать атмосферу, которая способствует учебному процессу и взаимодействию между
                участниками.
            </p>
        </div>
    </div>
    ...
    <div class="row justify-content-center text-center">
        ...
        <div class="col-lg-6">
            <ul class="list-unstyled fs-4 text-muted">
                ...
                <li><strong>E-mail:</strong> <a href="mailto:masterlector@mail.ru" class="text-decoration-none">masterlector@mail.ru</a></li>
