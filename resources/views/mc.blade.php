...
@section('content')
<img src="{{asset('build/images/mc1.jpg')}}" alt="" class='my-5 w-100'>
<p class='fs-3'>Крутое описание мастер-класса Крутое описание мастер-класса Крутое описание мастер-класса Крутое описание мастер-класса</p>
<div class="d-flex">

    <div class=" d-flex justify-items-center align-items-center me-5">
        <button type="button" class="seat-free border border-5 border-black rounded-4" data-bs-toggle="modal" data-bs-target="#exampleModal"></button>
        <span class='fs-3 ms-3'>Свободно</span>
    </div>
    ...
    <div class="d-flex justify-items-center align-items-center">
        ...
        <span class='fs-3 ms-3'>Занято</span>
    </div>
...
<div class='w-100 mt-5 class-padding class d-flex justify-content-center flex-wrap'>
    <div class='d-flex w-100 flex-wrap justify-content-center'>
        ...
        <div class='d-flex class-right-top justify-content-end w-100'>
            <button type="button" class="seat-free border border-5 border-black rounded-4 seat-top-margin" data-bs-toggle="modal" data-bs-target="#exampleModal"></button>
        </div>
    </div>
    <div class='d-flex w-100 flex-wrap justify-content-center'>
